...
data1 = pd.read_excel("../data/increase.xlsx", index_col=0)
...
line2 = ax1.plot_date(data1.index, data1.iloc[:, 1], color="blue", marker="^", markersize=2, alpha=0.2, label="Supply Power")
